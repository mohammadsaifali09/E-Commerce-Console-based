...
public class ProductBuy
{
    ...
    {
        products.clear();
        products.add(new Product("ADIDAS", 784));
        products.add(new Product("Jack & Jones", 694));
        products.add(new Product("Roadster", 799));
        products.add(new Product("Allen Solly", 504));
        return products;
    }
    ...
    {
        products.clear();
        products.add(new Product("Samsung", 13600));
        products.add(new Product("Whirlpool", 16400));
        products.add(new Product("LG", 9899));
        products.add(new Product("Haier", 11999));
        return products;
    }
}
